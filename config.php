...
// This move will save us from duplicating all lines from Boost Union's config.php into NOS's config.php.
...
// Then, we require NOS's locallib.php to make sure that it's always loaded.
require_once($CFG->dirroot . '/theme/nos/locallib.php');

// Next, we overwrite only the settings which differ between Boost Union and NOS.
$THEME->name = 'nos';
...
// Lastly, we replicate some settings from Boost Union at runtime into NOS's settings.
...
// it would be quite ugly to duplicate all of these settings again to NOS.
