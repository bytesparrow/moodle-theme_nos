...
$string['choosereadme'] = 'NOS is a theme that allows the manipulation of Moodle\'s site-layout completely';
$string['configtitle'] = 'NOS';
$string['settingsoverview_buc_desc'] = 'NOS is based on Boost Union with all it\'s features.';
...
// Privacy API.
$string['privacy:metadata'] = 'The NOS theme does not store any personal data about any user.';
